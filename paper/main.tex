...
\usepackage{url}
\usepackage{booktabs}
\title{Semantic Force Closure Revisited: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about grasping and language-conditioned manipulation. The original research bet was: Test when semantic object categories change the relevant closure conditions. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item PONG: Probabilistic Object Normals for Grasping via Analytic Bounds on Force Closure Probability (2023)
\item GraspMind: Multi-Granularity Language-Conditioned Affordance Prediction for Robotic Grasping (n.d.)
\item Development and Evaluation of a Vision-Language Guided Robotic Manipulation Pipeline (n.d.)
\item Development and Evaluation of a Vision-Language Guided Robotic Manipulation Pipeline (n.d.)
\item Analysis of Contact Force and Shape Change on Grasping a Square Object Using an Actual Fin Ray Soft Gripper (2023)
\end{itemize}
